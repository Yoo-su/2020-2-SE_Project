...
function EmployeeDetailPage({ location }) {
  ...
  function bringMoney() {
    axios
      .get("https://every-server.herokuapp.com/api/empDetail", {
  ...
  function bringWorkInfo() {
    axios
      .get("https://every-server.herokuapp.com/api/workHistory", {
        ...
        <div id="empDetailContent">
                ...
                <button
                  onClick={() => {
                    function updateSalary() {
                      axios
                        .get(
                          "https://every-server.herokuapp.com/api/updateSalary",
                          {
                            params: {
                              newSalary: newSalary,
                              userEmail: emp.email,
          ...
          <button
            ...
            onClick={() => {
              function payforWage() {
                axios
                  .get("https://every-server.herokuapp.com/api/payForWage", {
